...
upload_location = "" #upload location example /home/user/server/upload/
tmp_location = "" #temp location example /home/user/server/tmp/
max_size = "400000000" #max size in Bytes
